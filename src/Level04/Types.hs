...
encodeComment = E.mapLikeObj $ \c ->
  E.atKey' "commentId" E.int (getCommentId $ commentId c) . 
  E.atKey' "commentTopic" E.text (getTopic $ commentTopic c) . 
  E.atKey' "commentBody" E.text (getCommentText $ commentBody c) . 
